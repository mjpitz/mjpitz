...
![Version: 22.3.1](https://img.shields.io/badge/Version-22.3.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.8.0](https://img.shields.io/badge/AppVersion-2.8.0-informational?style=flat-square)
...
| ui.image.repository                        | string | `"jc21/registry-ui"`          | The image that contains the registry UI.                                                                                                                          |
| ui.image.tag                               | string | `"2.0.2"`                     | The tag of the image that contains the registry UI.                                                                                                               |
