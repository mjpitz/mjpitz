...
In this week's episode, we explore AI's ability to produce clean, well-structured data through the use of workflow-based
automation tools. Using a personal database, we'll integrate solutions like [n8n][], [MCP's][], and Claude Desktop's
capabilities.
...
Earlier this year, I started to think about how [12Factor][] considerations have changed since they were first published
in 2011. Written in the hay-day of microservices and small, independent git repos for version management, how have these
decisions held up in the modern day? In this episode, Josh and I step through the 12Factor pattern and discuss the
things we would change given our experience and AI needs.
