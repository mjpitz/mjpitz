...
for me over 20 years ago. After some time, I decided to get a degree in Software Engineering. My career started off at
Indeed and I have bounced between a handful of start-ups since. Most of what I write about is fairly technical, but I
try to include less technical content every so often.

One thing you'll notice about my site is that it uses a hyper-legible font. I often struggle to differentiate between
characters, especially on screens. So I use hyper-legible fonts and screen-readers to make my life a bit easier.
